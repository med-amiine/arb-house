        ...
        <div className="space-y-3">
          <div className="flex justify-between items-center p-3 bg-void rounded-lg">
            ...
            <span className="font-mono font-medium">
              ${assetsNum.toLocaleString(undefined, { maximumFractionDigits: 2 })}
            </span>
          </div>
          ...
          <div className="flex justify-between items-center p-3 bg-void rounded-lg">
            ...
            <span className="font-mono font-medium">
              ${pendingAssets.toLocaleString(undefined, { maximumFractionDigits: 2 })}
            </span>
          </div>
              ...
              {withdrawals.map((w, i) => (
                <div key={i} className="flex justify-between items-center text-sm p-2 bg-void rounded">
                  ...
                  <span className="font-mono">
                    ${Number(formatUnits(w.assets, 6)).toFixed(2)}
                  </span>
                </div>
              ))}
            </div>
